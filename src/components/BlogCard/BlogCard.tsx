    ...
    return (
        <div className='max-w-[525px] group'>
            <div className='overflow-hidden'>
                <Image width={900} height={600} alt="blog image" src={blog.img} className='group-hover:scale-110 transform transition-transform ease-in-out duration-1000 cursor-pointer' />
            </div>
