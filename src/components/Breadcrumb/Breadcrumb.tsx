...
const Breadcrumb = () => {
    ...
    let route = ''
    if (location === '/login' || location === '/register' || location === '/collections' || location === '/sale' || location === '/blogs' || location === '/cart' || location === '/account' || location === '/addresses' || location === '/users' || location === '/allproducts' || location === '/orders' || location === '/wishlist') {
