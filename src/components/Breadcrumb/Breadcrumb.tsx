...
const Breadcrumb = () => {
    ...
    let route = ''
    if (location === '/login' || location === '/register' || location === '/collections' || location === '/sale' || location === '/cart' || location === '/account' || location === '/addresses' || location === '/users' || location === '/allproducts' || location === '/wishlist') {
