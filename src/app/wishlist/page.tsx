...
const Wishlist = () => {
    ...
    return (
        <>
            <Breadcrumb />
            <div className='container min-h-[calc(100vh-268px)] content-center text-center'>
                {
                    wishlistItems.length ? (<div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 gap-4 my-4'>
                        {
